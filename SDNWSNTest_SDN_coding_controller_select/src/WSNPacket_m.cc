...
void WSNPacket::copy(const WSNPacket& other)
{
    ...
    this->isCoded_ = other.isCoded_;
    this->srcId2 = other.srcId2;
...
void WSNPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->isCoded_);
    doParsimPacking(b,this->srcId2);
    doParsimPacking(b,this->seq2);
}
...
void WSNPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->isCoded_);
    doParsimUnpacking(b,this->srcId2);
    doParsimUnpacking(b,this->seq2);
}
...
bool WSNPacket::isCoded() const
{
    return this->isCoded_;
}

void WSNPacket::setIsCoded(bool isCoded)
{
    this->isCoded_ = isCoded;
}

int WSNPacket::getSrcId2() const
{
    return this->srcId2;
}

void WSNPacket::setSrcId2(int srcId2)
{
    this->srcId2 = srcId2;
}

int WSNPacket::getSeq2() const
{
    return this->seq2;
}

void WSNPacket::setSeq2(int seq2)
{
    this->seq2 = seq2;
}
...
unsigned int WSNPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_isCoded
        FD_ISEDITABLE,    // FIELD_srcId2
        FD_ISEDITABLE,    // FIELD_seq2
    };
...
int WSNPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "isCoded") == 0) return baseIndex + 7;
    if (strcmp(fieldName, "srcId2") == 0) return baseIndex + 8;
    if (strcmp(fieldName, "seq2") == 0) return baseIndex + 9;
...
std::string WSNPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_isCoded: return bool2string(pp->isCoded());
        case FIELD_srcId2: return long2string(pp->getSrcId2());
        case FIELD_seq2: return long2string(pp->getSeq2());
        default: return "";
    }
}
...
void WSNPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isCoded: pp->setIsCoded(string2bool(value)); break;
        case FIELD_srcId2: pp->setSrcId2(string2long(value)); break;
        case FIELD_seq2: pp->setSeq2(string2long(value)); break;
...
omnetpp::cValue WSNPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_isCoded: return pp->isCoded();
        case FIELD_srcId2: return pp->getSrcId2();
        case FIELD_seq2: return pp->getSeq2();
...
void WSNPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_isCoded: pp->setIsCoded(value.boolValue()); break;
        case FIELD_srcId2: pp->setSrcId2(omnetpp::checked_int_cast<int>(value.intValue())); break;
        case FIELD_seq2: pp->setSeq2(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'WSNPacket'", field);
    }
}
